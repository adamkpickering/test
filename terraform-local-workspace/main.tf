...
provider "rancher2" {
    api_url = "https://localhost:8901/v3"
    access_key =  "token-bpbq6"
    secret_key =  "gstxv6qtlmxqwgz4tvtwt8qzzxf8qcp28fd8zk4tlpt6qnk8kzwdt9"
    insecure = true
}
...
# output "custom_ca_bundle_output" {
#   value = rancher2_catalog_v2.rancher.ca_bundle
# }
